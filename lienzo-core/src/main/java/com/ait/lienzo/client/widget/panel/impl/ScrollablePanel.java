...
public class ScrollablePanel extends LienzoBoundsPanel {
    ...
    private static int DRAG_BOUNDS_LIMIT_SIZE = 50;
    ...
    private void setupPanels() {
        ...
        LienzoPanelEvents.addPrimitiveDragStartEventListener(getLienzoPanel(), evt -> {
            isDragging = true;
        });
        ...
        LienzoPanelEvents.addPrimitiveDragEndEventListener(getLienzoPanel(), evt -> {
            isDragging = false;
        });
    ...
    private void initViewport() {
        getViewport().addViewportTransformChangedHandler(event -> {
            refresh();
        });
    }
